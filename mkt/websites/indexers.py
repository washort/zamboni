        ...
        mapping = {
            doc_type: {
                'properties': {
                    ...
                    'icon_hash': cls.string_not_analyzed(),
                    'icon_type': cls.string_not_analyzed(),
                    ...
                    # FIXME: we probably want url to be analyzed, but with a
                    # better suited analyzer.
                    'url': {'type': 'string', 'analyzer': 'default_icu'},
