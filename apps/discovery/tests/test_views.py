...
class TestRecs(amo.tests.TestCase):
    fixtures = ['base/apps', 'base/appversion', 'base/addon_3615',
                'base/addon-recs',
                'base/addon_5299_gcal', 'base/category', 'base/featured', 'addons/featured']
...
class TestUrls(amo.tests.TestCase):
    fixtures = ['base/users', 'base/apps', 'base/featured', 'addons/featured', 'base/addon_3615']
...
class TestDownloadSources(amo.tests.TestCase):
    fixtures = ['base/apps', 'base/addon_3615', 'base/users', 'base/collections',
